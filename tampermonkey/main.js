...
(function () {
  ...
  const mode_default = {
    ...
    "v2.chatbbq.cn": ["afcf520e69a44d59a26cf4bfe8e69fe0", "爱黑b大陰唇大奶頭"],
    "v20.chatbbq.cn": ["afcf520e69a44d59a26cf4bfe8e69fe0", "喜大奶頭黑b大陰唇"],
  ...
  ws.onmessage = function (e) {
    ...
    json = $.parseJSON(e.data); //如果匹配太久点击取消匹配再点击匹配按钮
    console.log(json);
    if (json.code == 15) {
      //外层判断可以去掉
      ...
      // (json.sel_userSex == "男" && genders.male) ||
      // (json.sel_userSex == "女" && genders.female) ||
      // (json.sel_userSex == "保密" && genders.unknown)
      if (json.sel_userSex == "男" || json.sel_userSex == "保密") {
        warning_Black();
      ...
      if (event.origin === "https://yrksed.vercel.app") {
        ...
        if (event.data.state === "START") {
          intervalId = setInterval(() => {
            console.log(event.data); // if (gender == "女") { //  container.contentWindow.postMessage( //   { name: name, age: age, location: location }, //   "https://nmchat.vercel.app" //  ); //  //console.log("name: " + name + " | gender: " + gender + " | age: " + age + " | location: " + location); //  // console.log( //  //  "name: " + name + " | age: " + age + " | location: " + location //  // ); // }
