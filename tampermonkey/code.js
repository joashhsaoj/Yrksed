...
$(".title-left").click(function () {
  $(".left-main").animate({ left: "0%" }, 500);
});

$(".left-main-pannel,.left-main-pannel_upUserlist").click(function () {
  $(".left-main").animate({ left: "-100%" }, 500);
});
...
$(".right-main-pannel").click(function () {
  $(".right-main").animate({ left: "100%" }, 500);
});

$("#btn_creat").click(function () {
  $("#btn_inroom").trigger("click");
});
...
function fun_more() {
  ...
  $("#more_msgback").click(function () {
    var lastTime = sel_userid
      ? pri_lastSendTime[sel_userid]
        ? sel_userid + "_" + pri_lastSendTime[sel_userid]
        : ""
      : pub_lastSendTime;
    if (ws && ws.readyState == 1 && lastTime) {
      var lay_index = layer.confirm(
        "是否确定撤回最新消息？",
        {
          skin: "demo-class",
          btn: ["确定", "取消"],
...
(function () {
  ...
  WebSocket.prototype.__createSimpleEvent = function (b) {
    if (document.createEvent && window.Event) {
      ...
      return { type: b, bubbles: false, cancelable: false };
    }
  };
  WebSocket.prototype.__createMessageEvent = function (b, d) {
    if (
      ...
      if (document.createEvent && window.MessageEvent && !window.opera) {
        ...
        return { type: b, data: d, bubbles: false, cancelable: false };
      }
    }
  };
  ...
  error: function (XMLHttpRequest, textStatus, errorThrown) {
    if (textStatus == "timeout") {
      resultData = $.parseJSON(
        '{"code":"-1","msg":"网络延迟：' + errorThrown + '","data":{}}'
      );
    } else {
      resultData = $.parseJSON(
        '{"code":"-2","msg":"失败：' + textStatus + errorThrown + '","data":{}}'
      );
    }
  },
  complete: function () {},
...
function GetImgPort() {
  try {
    for (var i = 0; i < Imgarr.length; i++) {
      NetPing(
        "http://" + img_addr + ":" + Imgarr[i] + "/useripaddressv23.js",
        Imgarr[i]
      );
...
if (getQueryVariable("touserid") && getQueryVariable("tousername")) {
  dic_userlist[getQueryVariable("touserid")] =
    "" + decodeURI(getQueryVariable("tousername"));
...
if (serverPort != "" && !isNaN(serverPort)) {
  //console.info('shi')
  ws_addr =
    ws_addr.split(":")[0] + ":" + ws_addr.split(":")[1] + ":" + serverPort;
}
...
var SlideUserInfos = $.cookie("SlideUserInfos")
  ? $.cookie("SlideUserInfos")
  : "1";
...
var emoji = {
  "[最右]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c8/lxhzuiyou_thumb.gif",
  "[泪流满面]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/64/lxhtongku_thumb.gif",
  "[江南style]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/67/gangnamstyle_thumb.gif",
  "[偷乐]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fa/lxhtouxiao_thumb.gif",
  "[加油啊]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/03/lxhjiayou_thumb.gif",
  "[doge]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b6/doge_thumb.gif",
  "[喵喵]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/4a/mm_thumb.gif",
  "[笑cry]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/34/xiaoku_thumb.gif",
  "[xkl转圈]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f4/xklzhuanquan_thumb.gif",
  "[微笑]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/5c/huanglianwx_thumb.gif",
  "[嘻嘻]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0b/tootha_thumb.gif",
  "[哈哈]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6a/laugh.gif",
  "[可爱]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/14/tza_thumb.gif",
  "[可怜]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/af/kl_thumb.gif",
  "[挖鼻]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0b/wabi_thumb.gif",
  "[吃惊]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f4/cj_thumb.gif",
  "[害羞]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6e/shamea_thumb.gif",
  "[挤眼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c3/zy_thumb.gif",
  "[闭嘴]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/29/bz_thumb.gif",
  "[鄙视]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/71/bs2_thumb.gif",
  "[爱你]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/lovea_thumb.gif",
  "[泪]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9d/sada_thumb.gif",
  "[偷笑]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/19/heia_thumb.gif",
  "[亲亲]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/8f/qq_thumb.gif",
  "[生病]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b6/sb_thumb.gif",
  "[太开心]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/58/mb_thumb.gif",
  "[白眼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d9/landeln_thumb.gif",
  "[右哼哼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/98/yhh_thumb.gif",
  "[左哼哼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/zhh_thumb.gif",
  "[嘘]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a6/x_thumb.gif",
  "[衰]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/af/cry.gif",
  "[委屈]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/73/wq_thumb.gif",
  "[吐]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9e/t_thumb.gif",
  "[哈欠]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/cc/haqianv2_thumb.gif",
  "[抱抱]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/27/bba_thumb.gif",
  "[怒]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/7c/angrya_thumb.gif",
  "[疑问]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/5c/yw_thumb.gif",
  "[馋嘴]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a5/cza_thumb.gif",
  "[拜拜]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/70/88_thumb.gif",
  "[思考]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e9/sk_thumb.gif",
  "[汗]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/24/sweata_thumb.gif",
  "[困]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/kunv2_thumb.gif",
  "[睡]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/96/huangliansj_thumb.gif",
  "[钱]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/90/money_thumb.gif",
  "[失望]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0c/sw_thumb.gif",
  "[酷]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/cool_thumb.gif",
  "[色]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/20/huanglianse_thumb.gif",
  "[哼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/49/hatea_thumb.gif",
  "[鼓掌]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/36/gza_thumb.gif",
  "[晕]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d9/dizzya_thumb.gif",
  "[悲伤]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/1a/bs_thumb.gif",
  "[泪]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9d/sada_thumb.gif",
  "[偷笑]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/19/heia_thumb.gif",
  "[抓狂]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/62/crazya_thumb.gif",
  "[黑线]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/91/h_thumb.gif",
  "[阴险]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/yx_thumb.gif",
  "[怒骂]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/60/numav2_thumb.gif",
  "[互粉]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/89/hufen_thumb.gif",
  "[心]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/hearta_thumb.gif",
  "[伤心]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ea/unheart.gif",
  "[猪头]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/58/pig.gif",
  "[熊猫]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6e/panda_thumb.gif",
  "[兔子]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/81/rabbit_thumb.gif",
  "[ok]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d6/ok_thumb.gif",
  "[耶]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d9/ye_thumb.gif",
  "[good]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d8/good_thumb.gif",
  "[no]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ae/buyao_org.gif",
  "[赞]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d0/z2_thumb.gif",
  "[来]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/come_thumb.gif",
  "[弱]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d8/sad_thumb.gif",
  "[草泥马]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/7a/shenshou_thumb.gif",
  "[神马]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/60/horse2_thumb.gif",
  "[囧]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/15/j_thumb.gif",
  "[浮云]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/bc/fuyun_thumb.gif",
  "[给力]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/1e/geiliv2_thumb.gif",
  "[围观]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f2/wg_thumb.gif",
  "[威武]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/70/vw_thumb.gif",
  "[奥特曼]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/bc/otm_thumb.gif",
  "[礼物]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c4/liwu_thumb.gif",
  "[钟]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d3/clock_thumb.gif",
  "[话筒]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9f/huatongv2_thumb.gif",
  "[蜡烛]":
    "https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d9/lazhuv2_thumb.gif",
};

// 用户性别和地址开关信息
var userSex = $.cookie("userSex") ? $.cookie("userSex") : "保密";
var userAge = $.cookie("userAge") ? $.cookie("userAge") : "0";
var address_show = $.cookie("address_show")
  ? $.cookie("address_show")
  : "false";
var switchvipsex = $.cookie("switchvipsex") ? $.cookie("switchvipsex") : "0";
var switchVipAddress = $.cookie("switchVipAddress")
  ? $.cookie("switchVipAddress")
  : "0";
var randomVipCode = $.cookie("randomVipCode") ? $.cookie("randomVipCode") : "";

var switchHealthMode = $.cookie("switchHealthMode")
  ? $.cookie("switchHealthMode")
  : "0";
...
// 用户离开后的展示内容
var randomOutMessge =
  '<div id="userOutOnline" onclick="return false;" style="width: 260px;text-align: center;margin: 10px auto;color: #AAA;line-height: 20px;letter-spacing: 2px;background-color: transparent;border-radius: 5px;padding: 5px;border: 1px solid #009688;">';
randomOutMessge +=
  '<img class="GG_img" alt="Deskry 匿名聊" src="/img/gg/gg1.png" width="200" style="position: relative;top:0px;margin-bottom:5px;cursor:pointer;display:none;" />';
randomOutMessge +=
  '<div style="text-align: left; text-indent: 2em;font-size: 10px;">对方已离开本次对话，但是您可以在本页面继续给对方留言，对方会收到提示。</div>';
randomOutMessge +=
  '<div style="text-indent:2em;text-align:left;font-size: 10px;">重新匹配好友请点击左下角【返回】按钮，开始新的探索。</div>';
randomOutMessge +=
  '<div style="text-align:center;text-indent: 0em;"><span style="color: #5BC0DE; font-weight: 700;">nmliao.cn(匿名聊)</span></div>';
randomOutMessge +=
  '<div style="text-align: center; line-height: 18px; letter-spacing:2px;margin:5px;"><button type="button" class="btn btn-info btn_Leave_Message" style="margin-right:15px;display:none;">我要寻人</button><button type="button" class="btn btn-info btn_Show_Leave_Message">我要寻人</button></div>';
randomOutMessge += "</div>";

// 用户离开后的展示内容
var randomOutMessgeAD =
  '<div id="userOutOnline" onclick="return false;" style="width: 260px;text-align: center;margin: 10px auto;color: #AAA;line-height: 20px;letter-spacing: 2px;background-color: transparent;border-radius: 5px;padding: 5px;border: 1px solid #009688;">';
randomOutMessgeAD +=
  '<img class="GG_img" alt="Deskry 匿名聊" src="/img/gg/gg1.png" width="200" style="position: relative;top:0px;margin-bottom:5px;cursor:pointer;display:;" />';
randomOutMessgeAD +=
  '<div style="text-align: left; text-indent: 2em;font-size: 10px;">对方已离开本次对话，但是您可以在本页面继续给对方留言，对方会收到提示。</div>';
randomOutMessgeAD +=
  '<div style="text-indent:2em;text-align:left;font-size: 10px;">重新匹配好友请点击左下角【返回】按钮，开始新的探索。</div>';
...
$(function () {
  ...
  window.onmousedown = function (e) {
    ...
    if (
      sign == "layui-layer-content" ||
      e.target.outerHTML.indexOf("data-page") != -1
    )
      return;
    ...
    .click(function () {
      ...
      if (ws && ws.readyState == 1) {
        ...
        if (sel_userid != "") {
          inputStatus_int = 0;
          sendJson(
            "touser_" + sel_userid + "_" + dic_userlist[sel_userid],
            v,
            true
          );
          ...
          layer.msg(
            "请点击【匹配】按钮连接新用户<br/>或是点击左侧历史用户列表进行留言"
          );
        }
        $("#inp_say").val("");
      } else {
  ...
  $("#sharelink").click(function () {
    if (!index_sharelink) {
      index_sharelink = layer.tips(
        "<div style='color:#000;margin:10px 10px'>" +
          "<input id='sharelink_link' type='text' class='form-control' value=" +
          window.location.href +
          "?rname=" +
          cur_rname +
          (cur_rpsw ? "&rpsw=" + cur_rpsw : "") +
          " />" +
...
$(".btn_QR_Share").click(function () {
  ...
  var tempdd =
    '{"myUserID":"' +
    (typeof $.cookie("user_id") == "undefined" ? "" : $.cookie("user_id")) +
    '","area":"' +
    ws_addr.split(":")[2] +
    '"}';
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.code == 0) {
        ...
        NoticeStr +=
          "<div style='text-align:center;margin-bottom:10px;color:aqua;'>【" +
          Notice1_WXGZHTitle +
          "】</div>";
        NoticeStr +=
          "<div style=text-align:center;margin-bottom:15px;><img width='200' height='auto' src='/" +
          data.msg +
          "'></div>";
        NoticeStr += "<div style='text-align:center;'></div>";
        NoticeStr +=
          "<div style='text-align:center;color:#BBB;font-size:10px;'>长按保存图片分享到社交平台<br/>您的好友就能用匿名身份与您交流了哦 ^_^</div>";
        NoticeStr += "</div>";
...
function init_control() {
  ...
  if (!$.cookie("user_id")) {
    $("#Tips_Warn").prepend(
      '<span style="color:#666;" onclick="login()">【当前为匿名状态，建议点击此处注册登录保留好友纪录】</span><br/>'
    );
...
function init_geturlparams() {
  ...
  if (request.QueryString("rname") != null) {
    $.cookie(
      "room_name_random",
      decodeURIComponent(request.QueryString("rname")),
      { expires: 365 }
    );
    $.cookie(
      "room_psw_random",
      !request.QueryString("rpsw")
        ? cur_rpsw
        : decodeURIComponent(request.QueryString("rpsw")),
      { expires: 365 }
    );
...
function fun_getnickname(isauto) {
  if (
    !$.cookie("user_id") ||
    !$.cookie("user_nickname_random") ||
    !$.cookie("room_name_random") ||
    !isauto
  ) {
    ...
    setTimeout(function () {
      $.getJSON(
        "/Act/WebService.asmx/getRandnikename",
        { act: "getRanNick" },
        function (json) {
          if (json.state == "OK") {
            //fun_loading(false);
            ...
            if (!$.cookie("room_psw_random"))
              $.cookie("room_psw_random", cur_rpsw, { expires: 365 });
            if (!isauto) sendJson("chgname", json.msg.nickname, true);
            else {
              $.cookie("user_nickname_random", json.msg.nickname, {
                expires: 365,
              });
  ...
  if (ifAutoConn) {
    ...
    ws.onopen = function (e) {
      ...
      if ($.cookie("randomVipCode")) {
        sendJson(
          "sign",
          '{"rname":"公共场所","rpsw":"","first_message_time":"' +
            first_message_time +
            '","randomvipcode":"' +
            randomVipCode +
            '","randomvipsex":"' +
            ...
            '"}',
          true
        ); // 2018-07-16 重启服务端后用户可直接进入之前的带密码的房间
      } else {
        sendJson(
          "sign",
          '{"rname":"公共场所","rpsw":"","first_message_time":"' +
    ...
    ws.onmessage = function (e) {
      ...
      switch (json.code) {
        case -3:
          ...
          break; //有新链接，旧的断开
        case -2:
          fun_fkxx(json.content);
          break; //反馈信息
        case -1:
          isforceOut = json.forceout;
          setTimeout(function () {
            Double_Con_Limit(json);
          }, 0);
          break; //警告信息
        ...
        case 3:
          ...
          break; //用户离线
        case 4:
          fun_userchgname(json);
          break; //用户更改名称
        case 5:
          fun_recbrodata(json);
          break; //接收广播消息
        case 6:
          fun_bindtoallmsg(json);
          break; //绑定所有的广播消息
        case 7:
        ...
        case 11:
          ...
          break; // 全体公告
        case 12:
          Con_Succ(json.content);
          break; // 连接服务器成功
        case 13:
          random_queue_get_random(json.content);
          break; // 进入随机好友队列
        case 130:
          random_queue_get_viprandom(json);
          break; // 您的激活码已过期
        case 131:
          random_queue_get_viprandom(json);
          break; // 您的激活码不存在
        ...
        case 134:
          random_queue_get_viprandom(json);
          break; // 已进入VIP匹配队列,额外情况
        case 135:
          random_queue_get_viprandom(json);
          break; //  vip 激活码防止多人同时使用
        case 136:
          random_queue_get_viprandom(json);
          break; //  暂无
        case 137:
        ...
        case 139:
          ...
          break; //  vip激活码不能为空
        case 14:
          random_queue_get_random_cancel(json.content);
          break; // 退出随机好友队列
        case 15:
          random_queue_get_random_getID(json);
          break; // 获取随机好友ID
        case 16:
          random_queue_get_random_Out();
          break; // 获取随机好友-对方离开
        case 17:
        ...
        case 22:
          layer.msg(
            "【举报成功】<br/>感谢您的反馈！<br/>已将对方列入黑名单<br/>您已不会再收到其所发信息",
            { time: 5000 }
          );
          break; // 对被举报用户进行检测
        case 30:
          ShowUserLoginInfo(json);
          break; // 查看用户登陆信息
        default:
        ...
        if (!isforceOut) {
          ...
          tick_autoConnect = setInterval(function () {
            ...
            if (reConnectCount < 4) {
              ...
              layer.msg("检测到您多次连接失败<br/>请检查网络连接是否正常", {
                time: 10000,
              });
    ...
    tick_autoConnect = null;
    layer.alert(
      "请勿重复登陆<br/>如没有重复登陆,可尝试关闭所有本社区页面<br/>（检查微信悬浮窗是否已有登陆）<br/>等待30秒后再访问或直接使用页面【注销】功能",
      { icon: 6, title: "【断开连接】" }
    );
  }
}
...
function limitTips(json) {
  //layer.msg(json.content, { time: 5000 });
  layer.msg(
    "您因违反规定，已被禁言<br/>非恶意违规者 2 分钟自动解封，如误封<br/>请将页面下方【身份码】发给客服进行申诉",
    { time: 10000 }
  );
}
...
function fun_Notice_first() {
  var json = $.parseJSON(
    '{"code":11,"content":"<span style=\'color:red;font-weight: 700;\'>【重要！已有用户被骗！】</span><br/>千万不要添加对方qq或微信好友后安装其发给的app，已有人安装后【中毒】导致通讯录和相册视频等信息被盗，然后被勒索，社区已配合警方追查，请大家一定要小心！"}'
  );
...
function Notice(json) {
  ...
  setTimeout(function () {
    var NoticeStr =
      "<div style='padding: 10px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;text-align:center;'>";
    NoticeStr += json.content;
    NoticeStr += "<div class='loginTipsKF'>";
    //NoticeStr += "<div>官方微信公众号【Deskry 匿名社区】</div>";
    NoticeStr +=
      "<div>客服QQ：<a href='http://wpa.qq.com/msgrd?v=3&uin=2868355448&site=qq&menu=yes' target='_blank'>2868355448</a></div>";
...
function Notice1() {
  if (!wx || (wx && getQueryVariable("tg") == "1")) {
    var NoticeStr =
      "<div style='padding: 10px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;'>";
    NoticeStr +=
      "<div style='text-align:center;margin-bottom:0px;'>官方微信公众号上线啦</div>";
    NoticeStr +=
      "<div style='text-align:center;margin-bottom:0px;color:aqua;'>【" +
      Notice1_WXGZHTitle +
      "】</div>";
    NoticeStr +=
      "<div style=text-align:center;margin-bottom:15px;><img width='200' height='200' src='/img/sys/weixin/" +
      Notice1_WXGZH +
      "'></div>";
    NoticeStr +=
      "<div style='text-align:center;'>【长按保存图片 用微信扫一扫】</div>";
    NoticeStr +=
      "<div style='text-align:center;color:#BBB;font-size:10px;'>关注后访问更便捷，功能更强大<br/>微信公众号内访问无此弹窗 ^_^</div>";
    NoticeStr += "</div>";
...
function Notice2() {
  var NoticeStr =
    "<div style='padding: 10px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;letter-spacing:0px;'>";
  NoticeStr +=
    "<div style='text-align:center;margin-bottom:5px;font-weight: 700;font-size:15px;color:red;'>【重要公告】</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>请文明和谐交流</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>营造良好的网络环境</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>发布非法、违规图片或言论</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>会被禁止访问</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>并且屏蔽违规聊天内容</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>如您发现受到骚扰</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>可联系客服人员处理</div>";
  NoticeStr += "<ul class='loginTipsKF'>";
  //NoticeStr += "<li><span>微信公众号：</span><span>Deskry 匿名社区</span></li>";
  NoticeStr +=
    "<li><span>客服QQ：</span><span><a href='http://wpa.qq.com/msgrd?v=3&uin=2868355448&site=qq&menu=yes' target='_blank'>2868355448</a></span></li>";
...
function Notice3() {
  var NoticeStr =
    "<div style='padding: 10px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;letter-spacing:0px;'>";
  NoticeStr +=
    "<div style='text-align:center;margin-bottom:5px;font-weight: 700;font-size:15px;color:red;'>【系统升级维护】</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>即将进行进行版本更新</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>预计耗时几分钟以内</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>期间可能导致某些功能异常</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>有特别要求请及时与客服反馈</div>";
  NoticeStr +=
    "<div style='text-align:center;color:#DEDEDE;'>请知悉，谢谢</div>";
  NoticeStr += "<ul class='loginTipsKF'>";
  //NoticeStr += "<li><span>微信公众号：</span><span>Deskry 匿名社区</span></li>";
  NoticeStr +=
    "<li><span>客服QQ：</span><span><a href='http://wpa.qq.com/msgrd?v=3&uin=2868355448&site=qq&menu=yes' target='_blank'>2868355448</a></span></li>";
...
function Double_Con_Limit(json) {
  var layerCon = layer.alert(json.content, {
    time: 0,
    title: "",
    btn: ["我仍然要连接", "知道了"],
    icon: 6,
...
$("#user_Random").click(function () {
  ...
  $.ajax({
    ...
    success: function (data) {
      resultData = $.parseJSON(
        '{"code":"0","msg":"成功","data":' + JSON.stringify(data) + "}"
      );

      var list = resultData.data;
      var htmlstr = "";
      for (var i = 0; i < list.length; i++) {
        if (list[i].id == $.cookie("user_id")) continue;
        ...
        if ($.trim(list[i].nickname) != "") {
          htmlstr +=
            "<a id='userid_" +
            list[i].id +
            "' class='list-group-item userList' style='color:" +
            color +
            "' onfocus='this.blur()' onclick='click_userlist(id);'>" +
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        if ($.trim(list[i].nickname) != "") {
          htmlstr +=
            ...
            color +
            "' onfocus='this.blur()' onclick='click_userlist(id);'>" +
            "<img id='cancleheart_userid_" +
            list[i].id +
            "' onclick='CancleHeartUser(id);' alt='点击取消收藏' src='/img/sys/heart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
            "<span class='badge'></span><span style='margin-right:5px;position: absolute;top: 9px;left: 28px;' class='zql-bnt-user'></span>" +
            "<span style='margin-left: 40px;' class='nickname'>" +
            list[i].nickname +
            "<span>" +
...
$("#user_Random_Del").click(function () {
  ...
  Del_User_list(
    "random",
    "确定清空未收藏记录？<br/>任何一方清空，双方都会删除<br/>如误操作，可联系客服恢复"
  );
});
...
$("#user_My_Del").click(function () {
  ...
  Del_User_list(
    "heart",
    "确定清空已收藏记录？<br/>任何一方清空，双方都会删除<br/>如误操作，可联系客服恢复"
  );
});
...
function ManageUser(tuserALLid) {
  ...
  var htmlstr =
    ...
    "<div>" +
    "<p id='title_manageUser' style='margin:8px auto;color: #FFF;' class='oneline'>" +
    tusername +
    "</p>" +
  ...
  $("#manageUser_DelAll").click(function () {
    ...
    if (CurrUserType == "0") {
      Del_User_list(
        "random",
        "确定清空未收藏记录？<br/>任何一方清空，对应双方都会删除<br/>如误操作，可联系客服恢复"
      );
    } else {
      Del_User_list(
        "heart",
        "确定清空已收藏记录？<br/>任何一方清空，对应双方都会删除<br/>如误操作，可联系客服恢复"
      );
    }
  });
}
...
function ShowUserLoginInfo(json) {
  if (json.result == "1") {
    var htmlstr =
      "<div class='inroom_zone' style='text-align: center;'>" +
      "<p style='margin:8px auto;color: #FFF;' class='oneline'>当前在线状态：" +
      (json.data.IF_Online == "0" ? "已离线" : "在线") +
      "</p>" +
      "<p style='margin:8px auto;color: #FFF;' class='oneline'>最近登陆时间</p>" +
      "<p style='margin:8px auto;color: #FFF;' class='oneline'>" +
      json.data.TimeAll +
      "</p>" +
      "</div>";
...
$("#btn_random_break_AD").click(function () {
  var NoticeStr =
    "<div style='padding: 10px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;'>";
  NoticeStr +=
    "<div style='text-align:center;margin-bottom:5px;'>是否断开本次对话？</div>";
  NoticeStr +=
    "<div style='text-align:center;margin-bottom:0px;color:aqua;display:none;'>【】</div>";
  NoticeStr +=
    "<div style='text-align:center;margin-bottom:5px;' id='random_breakAD'><img width='180' src='/img/sys/weixin/deskryAD.jpg'></div>";
  NoticeStr +=
    "<div style='text-align:center;font-size: 10px;;color:aqua'>【长按图片识别二维码下载App】</div>";
  NoticeStr +=
    "<div class='layui-layer-btn layui-layer-btn-'><a id='random_breakAD_ok' class='layui-layer-btn0'>确定</a><a id='random_breakAD_cancel' class='layui-layer-btn1'>取消</a></div>";
  NoticeStr += "</div>";
...
$("#btn_buy_vipcode").click(function (e) {
  if (wx()) {
    ...
    window.open("http://alipay1.nmpipei.com/index.aspx");
    e.stopPropagation();
  }
});
...
$("#btn_MyOrders,#InformMyOrder").click(function (e) {
  if (wx()) {
    ...
    layer.msg("进入支付宝查询支付订单记录<br/>vip开头的订单号即是激活码", {
      time: 3000,
    });
    e.stopPropagation();
  }
...
function fun_newuser(json) {
  if (dic_userlist[json["user"].id]) return;
  ...
  $("#user_list").prepend(
    "<a id='userid_" +
      ...
      "' style='color:" +
      color +
      "' class='list-group-item userList' onfocus='this.blur()' onclick='click_userlist(id);'><span class='badge'></span><span style='margin-right:5px;' class='zql-bnt-user'></span><span class='nickname'>" +
      json["user"].nickname +
      "</span></a>"
  );
...
function fun_bindtoallmsg(json) {
  ...
  $("#old_mes_get").remove();
  $("#div_msgbox").prepend(
    '<div id = "old_mes_get" onclick = "get_old_messge();" style="width:200px;text-align:center;margin:10px auto;color:#09c;cursor: pointer;"><img alt="查看历史消息" src="/img/sys/time_pic.png" width="20" style="position: relative;top:-1px;" />查看历史消息</div>'
  );
    ...
    switch (code) {
      case 4: //用户修改名称
        htmlstr +=
          ...
          json_user[i].time +
          "</div>" +
          json_user[i].beforename +
          " --> " +
          json_user[i].nickname +
          "</div>";
        break;
      default:
        ...
        var color =
          cur_rauthor == id && code != 8 && code != 7 ? "orange" : "#ABABAB";
        var chattitle = !self
          ? "<span style='color:" +
            color +
            "'>" +
            json_user[i].nickname +
            "</span> " +
            "<span style='color:#d2d2d2;display:none;'>" +
            json_user[i].time +
            "</span><span class='timeSpan' style='color:#ABABAB;margin-left:5px;'>&nbsp;</span>"
          : "<img style='margin-right:5px;width:17px;height:17px;opacity:0.6;' src='/img/sys/ret.png'><span style='color:#d2d2d2;display:none;'>" +
            json_user[i].time +
            "</span><span style='color:#ABABAB;margin-right:5px;'>&nbsp;</span><span style='color:" +
            color +
            "'>" +
            json_user[i].nickname +
            "</span><span style='color:#d2d2d2;display:none;'>" +
            json_user[i].Tid +
            "</span>";
        htmlstr +=
          ...
          chattitle +
          "</div>" +
          "<div class='chatarrow' style='" +
          (self
            ? "right:5px;border-bottom: 8px solid #ffe6b8;"
            : "left:5px;border-bottom: 8px solid #cfffcf;") +
          "'></div><div id='" +
          (sortID(id) + json_user[i].time.replace(/:/g, "_")) +
          "' class='chat" +
          (self ? " selfchat" : "") +
          "' style='max-width:" +
          ($("#div_msgpanel").width() * 0 + 315) +
          "px;'>" +
          chg_resource(json_user[i].content, json_user[i].time) +
          "<br />" +
          "</div>" +
...
function fun_fromusermsg(json) {
  ...
  if (hex_md5($.cookie("user_id")) == fu.id) {
    ...
    if (sel_userid != fu.id) {
      var count =
        ($("#userid_" + fu.id + " .badge").text()
          ? parseInt($("#userid_" + fu.id + " .badge").text())
          : 0) + 1;
  ...
  $(".chatbox").each(function () {
    ...
    if ($(this).find("span:eq(1)").css("display") == "none") {
      ...
      if (mess_time == $(this).find("span:eq(1)").html()) {
        $(this)
          .find("div:eq(2)")
          .html("<span style='color:#bbb'>已撤回</span>");
      }
    }
  });
...
function click_userlist(id) {
  ...
  if (sel_userid != id) {
    ...
    $("#msg_title").html(
      '<span style="color:orange">' + dic_userlist[id] + "</span> - 私聊"
    );
    sel_userid = id;
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.code == 0) {
        ...
        $("#old_mes_get").remove();
        $("#div_privmsg").prepend(
          '<div id = "old_mes_get" onclick = "get_Random_Old_MessgePage();" style="width:200px;text-align:center;margin:10px auto;color:#09c;cursor: pointer;"><img alt="查看历史消息" src="/img/sys/time_pic.png" width="20" style="position: relative;top:-1px;" />查看历史消息</div>'
        );
...
function fun_chatbox(json_user, code) {
  ...
  switch (code) {
    ...
    default:
      ...
      var id =
        code == 8 || code == 7 ? hex_md5($.cookie("user_id")) : json_user.id; //为内容块指定唯一ID
      var color =
        cur_rauthor == id && code != 8 && code != 7 ? "orange" : "#ABABAB";
      var chattitle = !self
        ? "<span style='color:" +
      ...
      htmlstr =
        ...
        (self
          ...
          : "left:5px;border-bottom: 8px solid #cfffcf;") +
        "'></div><div id='" +
        (sortID(id) + json_user.time.replace(/:/g, "_")) +
        "' class='chat" +
        (self ? " selfchat" : "") +
        "' style='max-width:" +
        ($("#div_msgpanel").width() * 0 + 315) +
        "px;'>" +
        chg_resource(json_user.content, json_user.time) +
        "<br />" +
        "</div>" +
        "</div><div class='clearboth'></div>";
      break;
...
$("#div_msgbox").click(function () {
  che_message_focus = 1;
});
$("#div_msgbox").mouseenter(function () {
  che_message_focus = 0;
});
$("#div_privmsg").click(function () {
  che_message_focus = 1;
});
$("#div_privmsg").mouseleave(function () {
  che_message_focus = 0;
});
...
function fun_strtodate(str) {
  var d = new Date();
  return new Date(
    d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + d.getDate() + " " + str
  );
}
...
function sendJson(act, msg, self) {
  if (ws && ws.readyState == 1) {
    ...
    if (act.indexOf("inputStatusOn") != -1) {
      ...
      ws.send(
        JSON.stringify({ act: act, id: $.cookie("user_id"), userAge: userAge })
      );
    } else if (act == "randomOut") {
      // 匹配后离开
      ws.send(JSON.stringify({ act: act, id: $.cookie("user_id"), msg: msg }));
      ...
      ws.send(
        JSON.stringify({
          ...
          randomhealthmode: switchHealthMode,
          randomvipsex: switchvipsex,
          randomvipaddress: switchVipAddress,
        })
      );
    } else if (act == "sign") {
      ws.send(
        JSON.stringify({
          act: act,
          id: $.cookie("user_id"),
          name: $.cookie("user_nickname_random"),
          userSex: userSex,
          address_show: address_show,
          randomhealthmode: switchHealthMode,
          randomvipsex: switchvipsex,
      ...
      ws.send(
        JSON.stringify({
          act: act,
          rname: $.cookie("room_name_random"),
          rpsw: $.cookie("room_psw_random"),
          id: $.cookie("user_id"),
          name: $.cookie("user_nickname_random"),
          userip: userIP,
          useraddree: userAddree,
...
function init_initEmoji() {
  ...
  for (var i in emoji) {
    emoji_html +=
      "<span class='item_emoji' id='emoji_" +
      i +
      "' onclick='click_emojiItems(\"emoji_" +
      i +
      "\");'  title='" +
      i +
      "'><img class='imgitem_emoji' src='" +
      emoji[i] +
      "' /></span>";
  }
...
function fun_getuploadimg() {
  $.getJSON(
    "/asmx/upload.asmx/ProcessRequest",
    { act: "getUploadImg" },
    function (json) {
      if (json.code != -1) uploadPic = json.msg;
    }
  );
}
      ...
      if (em[i].indexOf(".") != -1) {
        if (em[i].indexOf(".wav") != -1) {
          ...
          if (wav)
            str = str.replace(
              em[i],
              '<audio controls="controls"><source src="/Voice/' +
                $.trim(wav) +
                '"></audio>'
            );
          ...
          if (rar) {
            ...
            str = str.replace(
              ...
              '<a href="/Files/' +
                rar_param[2] +
                '" target="_blank">' +
                '<img style="float:left;" src="http://' +
                img_addr +
                ':668/img/sys/rarico.png" />' +
        ...
        if (
          ...
          if (video)
            str = str.replace(
              em[i],
              "<video width='300' height='auto' controls='controls'  poster=''><source src='http://" +
                img_addr +
                ":" +
                FileProt +
                "/img/Upload/" +
          ...
          if (img) {
            str = str.replace(
              em[i],
              "<a class='fancybox' rel='group1' href='http://" +
                img_addr +
                ":" +
                FileProt +
                "/img/Upload/" +
                img +
                "' target='_blank'>" +
                "<img onerror='errpic(this)' style='max-width:" +
                ($("#div_msgpanel").width() * 0 + 200) +
                "px;' src='http://" +
                img_addr +
                ":" +
                FileProt +
...
function init_uploadPic() {
  if (!index_img) {
    index_img = layer.tips(
      "<div id='uploadimg_list' style='height:200px;'></div>" +
        "<button id='uploadimg_upload' class='btn btn-default uploadimg' type='button' style='float: right'>" +
        "<span class='sp_uploadimg'>上传</span></button>" +
        "<span style='color: #999;float: right;line-height: 35px;margin-right: 5px;position:absolute;top:0px;left:10px;'>上传后，点击图片/视频进行发送</span>" +
        ...
        "<div id='uploadimg_pages' style='float:right;margin-top:5px;'></div>",
      "#a_uploadimg",
      {
        tips: [1, "#FEFEFE"],
        shade: 0.4,
...
function imgupload_file(file) {
  ...
  if (sel_userid == "") {
    upUrl =
      ...
      ":" +
      FileProt +
      "/asmx/upload.asmx/ProcessRequest?act=uploadImgRandom";
  } else {
    upUrl =
      "http://" +
      img_addr +
      ":" +
      FileProt +
      "/asmx/upload.asmx/ProcessRequest?act=" +
      UpImg +
      "&userid=" +
      $.cookie("user_id");
  }
...
function imgupload_base64(base64str) {
  ...
  $.post(upUrl, { base64str: base64str }, function (d) {
    ...
    if (!issame) uploadPic.splice(0, 0, json.msg);
    bind_imglist(1); //自动跳转到第一页
    bind_imgpage();
  });
}
...
function bind_imglist(cur_page) {
  ...
  for (var i = 8 * (cur_page - 1); i < cur_page * 8; i++) {
    if (uploadPic[i]) {
      uploadpic_html +=
        "<div style='height:64px;float:left;margin:25px 5px;'>" +
        "<img id='uploadimgitem_" +
        uploadPic[i] +
        "'onclick='click_selimg(id);' onmouseover='mouseover_zoomimg(id);' onmouseout='mouseout_closezoom();' style='height:64px;width:64px;' src='http://" +
        img_addr +
        ":" +
        FileProt +
        "/img/Upload/" +
...
function mouseover_zoomimg(id) {
  ...
  if (index_zoomimg || true) return;
  var imgID = id.split("_")[1];
  var imgSuffix = id.split("_")[2];
  index_zoomimg = layer.tips(
    "<div><img style='max-width:100px;' src='http://" +
      img_addr +
      ":" +
      FileProt +
      "/img/Upload/" +
...
function fun_inroom() {
  var htmlstr =
    "<div class='inroom_zone'><div class='inroom_leftzone'>" +
    ...
    "<div class='inroom_rightzone' style='overflow-y:auto;'>" +
    fun_inroom_showhistory() +
    "</div></div>";
  ...
  $("#inroom_ok").click(function () {
    ...
    fun_loading(true);
    fun_applyroom(
      $.trim($("#inp_roomname").val()),
      $.trim($("#inp_roompsw").val())
    );
  });
}
...
function fun_inroom_addhistory(rname, rpws) {
  ...
  if (index == -1) {
    ...
    if (his_rooms.length == 11) his_rooms.pop();
  } else {
...
function fun_inroom_showhistory() {
  ...
  for (var i = 0; i < his_rooms.length; i++) {
    ...
    var color =
      his_rooms_colors[Math.floor(Math.random() * his_rooms_colors.length)];
    htmlstr +=
      "<button type='button' onclick='click_inroom_tag(\"" +
      info[0] +
      '","' +
      info[1] +
      "\")' class='btn btn-primary btn-xs' style='margin:8px 6px;background-color:" +
      color +
      ";border-color:" +
      color +
      "'>" +
...
function fun_showhotrooms(json) {
  ...
  for (var i = 0; i < rooms.length; i++) {
    htmlstr +=
      "<div class='class_hotrooms' onclick='click_hotroom(\"" +
      rooms[i].rname +
      '","' +
      rooms[i].needpsw +
      "\")'>" +
      ...
      "</div>" +
      rooms[i].rname +
      "<div style='color:orange;margin-left:5px;' class='" +
      (rooms[i].needpsw == 1 ? "hotrooms_lock" : "") +
      "'></div></div>";
  }
...
function Del_Cookies() {
  var lay_index = layer.alert(
    '注销会<span style="color:orange;">&nbsp;重置&nbsp;</span>所有身份信息<br/>建议操作前先保存您当前的身份码<br/>以备注销后使用【身份找回】功能<br/>恢复原来身份与历史聊天用户信息<br/>您当前的身份码为：<br/><span style="color:orange;">' +
      $.cookie("user_id") +
      "</span>",
    {
      skin: "demo-class",
...
function inputStatus() {
  ...
  if ($("#inp_say").val().trim() != "" && inputStatus_int == 0) {
    inputStatus_int = 1;
    sendJson(
      "inputStatusOn_" + sel_userid + "_" + dic_userlist[sel_userid],
      1,
      true
    ); // 触发输入提示
    ...
    inputStatus_int = 0;
    sendJson(
      "inputStatusOff_" + sel_userid + "_" + dic_userlist[sel_userid],
      0,
      true
    ); // 停止输入提示
  }
...
function fun_inputStatusOn() {
  if (!inputStatusTips) {
    inputStatusTips = layer.tips("对方正在输入...", ".input-area", {
      tips: [1, "#0FA6D8"],
      tipsMore: true,
      time: 0,
    });
...
$("#doAD").click(function () {
  window.location.href =
    "https://weidian.com/?userid=297880287&spider_token=6c3e";
});
...
function warning_Black() {
  var lay_index = layer.confirm(
    "确定举报并拉黑对方？<br/>被多人举报会自动封禁<br/>拉黑会在每天凌晨0点自动解除",
    {
      skin: "demo-class",
      title: "",
      btn: ["确定", "取消"],
...
$("#goBottom").click(function () {
  che_message_focus = 0;
  $("#div_msgbox").animate(
    { scrollTop: $("#div_msgbox")[0].scrollHeight },
    400
  );
  $("#div_privmsg").animate(
    { scrollTop: $("#div_privmsg")[0].scrollHeight },
    400
  );
});
...
function loginTips() {
  ...
  NoticeStr += "<ul>【用户须知】";
  NoticeStr +=
    "<li><span>1、</span><span>请遵守您所在国家地区的法律法规，禁止发布任何违反法律法规、广告、恶意刷屏的信息，违者将被禁止访问；</span></li>";
  NoticeStr +=
    "<li><span>2、</span><span>为了保障大家拥有和谐良好的聊天环境，公屏禁止发布图片；</span></li>";
  //NoticeStr += "<li><span>3、</span><span>房间密码为用户自建、自传播，其他人无权散播。房间审核通过后才能对外显示，一个工作日内审核完毕，请保持关注，也可联系客服加急处理，谨防受骗上当；</span></li>";
  NoticeStr +=
    "<li><span>3、</span><span>如果您在使用本站过程中遇到任何问题，可直接联系本站客服，我们会尽快为您处理。请勿轻易将自己隐私信息公布，以免被骗。</span></li>";
  NoticeStr += "</ul>";
  NoticeStr += "<ul class='loginTipsKF'>";
  //NoticeStr += "<li><span>微信公众号：</span><span>Deskry 匿名社区</span></li>";
  NoticeStr +=
  ...
  NoticeStr += "</ul>";
  NoticeStr +=
    "<div id='FirstNotice' style='text-align:center;color:aqua;font-size:13px;'>不再显示</div>";
  NoticeStr += "</div>";
  ...
  loginTipslayOpen = layer.open({
    ...
    yes: function (index, layero) {
      ...
      setTimeout(function () {
        layer.tips(
          '<div class="shake-slow shake-constant" style="color:#FFF;font-weight:700;">点击此处切换日、夜间模式</div>',
          $("#theme_sun_moon"),
          { tips: [3, "#009688"], time: 2000, shift: 6 }
        );

        setTimeout(function () {
          layer.tips(
            '<div class="shake-slow shake-constant" style="color:#FFF;font-weight:700;">点击此处切换背景色</div>',
            $("#colorpicker"),
            { tips: [3, "#009688"], time: 2000, shift: 5 }
          );

          setTimeout(function () {
            layer.tips(
              '<div class="shake-slow shake-constant" style="color:#FFF;font-weight:700;">开启青少年模式可屏蔽所有敏感信息和图片</div>',
              $("#health_mode_tip"),
              { tips: [1, "#009688"], time: 2000, shift: 4 }
            );
          }, 2000);
        }, 2000);
      }, 1500);
...
function XR() {
  layer.msg(
    "寻人、找回身份码请联系在线QQ客服<br/>需尽快，因为 3 天内找回的几率最大哦",
    { time: 2500 }
  );
...
function regist() {
  view_regist = layer.open({
    ...
    content:
      "/registSimple/regist.html??v=129&userID=" +
      $.cookie("user_id") +
      "&servername=" +
      ws_addr.split(":")[2],
  });
