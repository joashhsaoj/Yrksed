...
import StartAndStop from "./tabs/general/StartAndStop";
import Main from "./tabs/general/Main";
import Secondary from "./tabs/general/Secondary";
import Mode from "./tabs/other/Mode";
